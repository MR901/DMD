...
typedef uint16_t (*FontCallback)(const uint16_t*);
...
class DMD
{
  ...
  //Draw hindi String
  void drawStringH(int bX, int bY, const char *bChars, byte length, byte bGraphicsMode);

  //Select a text font
  void selectFont(const uint16_t* font);

  //Draw a single character
  int drawChar(const int bX, const int bY, const unsigned char letter, byte bGraphicsMode);
   //find hindi character
 int hin(const unsigned char letter,const unsigned char letter1,const unsigned char letter2,const unsigned char letter3);
  //Draw hindi character
  int drawCharH(const int bX, const int bY, const unsigned char letter,const unsigned char letter1,const unsigned char letter2,const unsigned char letter3, byte bGraphicsMode) ;

  //Find the width of a character
  int charWidth(const unsigned char letter);

  // hindi character width
 int charWidthH(const unsigned char letter,const unsigned char letter1,const unsigned char letter2,const unsigned char letter3);
  ...
  boolean stepMarquee( int amountX, int amountY);
   ...
   //Move the maquee accross by amount
  boolean stepMarqueeH( int amountX, int amountY);
